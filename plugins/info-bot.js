...
await conn.sendMessage(m.chat, {text: loadd[i], edit: key })}
  ...
  let mentionedJid = [m.sender]
    ...
    let sts = ` – *Info Bot Rimuru MultiDevice*
...
seconds: 18,
fileLength: 18,
 ptt: true, contextInfo: { forwardingScore: 999, isForwarded: false, externalAdReply: {title: 'Rimuru ᴍᴜʟᴛɪᴅᴇᴠɪᴄᴇ', body: wm, sourceUrl: 'https://chat.whatsapp.com/DXPU5F2cePXEaysvcImdUy', thumbnail: await (await fetch(thumb)).buffer(),}}  
  }) 
}
