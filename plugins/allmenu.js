...
let memek = { key: { remoteJid: 'status@broadcast', participant: '0@s.whatsapp.net' }, message: { orderMessage: { itemCount: 9999999999, status: 1, thumbnail: await conn.resize(await getBuffer(thumb),300,150), surface: 1, message: 'Rimuru ᴍᴜʟᴛɪᴅᴇᴠɪᴄᴇ', orderTitle: wm, sellerJid: '0@s.whatsapp.net' } } }
...
`.trimStart(),
  ...
  footer: '╰─── –',
  after: `Rimuru ᴀɪ By Dmsss ${global.version}`,
}
  try {
    ...
    let bjir = 'https://telegra.ph/file/8c7b95bba7719b179bfe5.jpg'
 ...
 type: 'audioMessage',  
 ptt: true, contextInfo: { forwardingScore: 999, isForwarded: false, externalAdReply: {title: 'Rimuru MultiDevice', body: wm, sourceUrl: 'https://chat.whatsapp.com/DXPU5F2cePXEaysvcImdUy', thumbnail: await (await fetch(bjir)).buffer(),}}  
  }) 
    } catch (e) {
