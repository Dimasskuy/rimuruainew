...
let bjir = 'https://telegra.ph/file/ab33643dc8cd957035862.jpg'
let pp = await conn.profilePictureUrl(who).catch(_ => hwaifu.getRandom())
let name = await conn.getName(who)

let delay = time => new Promise(res => setTimeout(res, time))

  await conn.reply(m.chat, 'MY CREATOR RIMURU MULTIDEVICE', fpayment)
...
seconds: 22,
fileLength: 22,
 ptt: true, contextInfo: { forwardingScore: 999, isForwarded: false, externalAdReply: {title: 'MY CREATOR RIMURU-AI', body: wm, sourceUrl: 'https://wa.me/6282257529886?text=hai+bang', thumbnail: await (await fetch(bjir)).buffer(),}} 
 })
